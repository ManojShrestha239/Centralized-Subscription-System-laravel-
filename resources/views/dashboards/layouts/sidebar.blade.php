                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('clients.index') }}"
                            @click.prevent="selected = (selected === 'Clients' ? '':'Clients')" class="menu-item group"
                            :class="(selected === 'Clients') || '{{ Route::currentRouteName() }}'
                            === 'clients.index' || '{{ Route::currentRouteName() }}'
                            === 'clients.create' || '{{ Route::currentRouteName() }}'
                            === 'clients.edit' ?
                                'menu-item-active' : 'menu-item-inactive'">
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('clients.index') }}" class="menu-dropdown-item group"
                                        ...
                                        === 'clients.index' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Client List
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('clients.create') }}" class="menu-dropdown-item group"
                                        :class="'{{ Route::currentRouteName() }}'
                                        === 'clients.create' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Create Client
                                    </a>
                                </li>
